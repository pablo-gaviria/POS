...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="?page=products&action=update" class="form" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                                ...
                                <div style="flex: 1;">
                                    <select id="category" name="category" required>
                                        ...
                                        <?php foreach ($categories as $cat): ?>
                                            <option value="<?php echo htmlspecialchars($cat['name']); ?>" <?php echo $product['category'] === $cat['name'] ? 'selected' : ''; ?>><?php echo htmlspecialchars($cat['name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="barcode" name="barcode" value="<?php echo htmlspecialchars($product['barcode'] ?? ''); ?>">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($product['image'])): ?>
                                <div style="margin-top: 10px;">
                                    <p style="margin: 0 0 5px 0;"><strong>Current Image:</strong></p>
                                    <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" style="max-width: 150px; height: auto; border: 1px solid #ddd; padding: 5px;">
